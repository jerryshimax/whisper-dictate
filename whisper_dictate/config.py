...
INDICATOR_WIDTH_RESULT = 36
INDICATOR_WIDTH_COPY = 200
INDICATOR_HEIGHT = 24
...
METER_UPDATE_INTERVAL_SEC = 0.05  # ~20 fps
METER_MIN_DB = -45.0
METER_MAX_DB = 0.0
METER_EMA_ALPHA = 0.35
IDLE_LABEL = "○"
TRANSCRIBING_LABEL = "◌"
LOADING_LABEL = "◌"
DONE_LABEL = "✓"
COPY_READY_LABEL = "✓ Copy"
